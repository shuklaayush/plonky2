...
use crate::keccak::columns::{reg_step, NUM_COLUMNS, NUM_PUBLIC_INPUTS};
use crate::keccak::keccak_stark::NUM_ROUNDS;

pub(crate) fn eval_round_flags<F: Field, P: PackedField<Scalar = F>>(
    vars: &StarkFrame<P, P::Scalar, NUM_COLUMNS, NUM_PUBLIC_INPUTS>,
...
pub(crate) fn eval_round_flags_recursively<F: RichField + Extendable<D>, const D: usize>(
    ...
    vars: &StarkFrame<ExtensionTarget<D>, ExtensionTarget<D>, NUM_COLUMNS, NUM_PUBLIC_INPUTS>,
